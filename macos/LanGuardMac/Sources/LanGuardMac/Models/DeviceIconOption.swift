...
enum DeviceIconCatalog {
    ...
    static let options: [DeviceIconOption] = [
        ...
        DeviceIconOption(id: "gamecontroller", title: "Game Console", systemImage: "gamecontroller"),
        ...
        DeviceIconOption(id: "externaldrive.connected.to.line.below", title: "NAS", systemImage: "externaldrive.connected.to.line.below"),
        DeviceIconOption(id: "iphone", title: "Phone", systemImage: "iphone"),
        DeviceIconOption(id: "powerplug", title: "Plug", systemImage: "powerplug"),
        DeviceIconOption(id: "gauge.with.dots.needle.50percent", title: "Power Meter", systemImage: "gauge.with.dots.needle.50percent"),
        ...
        DeviceIconOption(id: "bolt.horizontal.circle", title: "Smart Relay", systemImage: "bolt.horizontal.circle"),
