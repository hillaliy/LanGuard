...
MIDDLEWARE = [
    ...
    "core.user_messages.ApiMessageMiddleware",
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "core.user_messages.api_exception_handler",
}
...
SCAN_MAX_HOSTS = int(os.getenv("SCAN_MAX_HOSTS", "1024"))
SCAN_MAX_RANGES = int(os.getenv("SCAN_MAX_RANGES", "16"))
SCAN_ALLOW_PUBLIC_RANGES = env_bool("SCAN_ALLOW_PUBLIC_RANGES", default=False)
SCAN_LOCK_STALE_SECONDS = int(os.getenv("SCAN_LOCK_STALE_SECONDS", "1800"))
PORT_SCAN_MAX_PORTS = int(os.getenv("PORT_SCAN_MAX_PORTS", "64"))
DETAILED_PORT_SCAN_MAX_PORTS = int(os.getenv("DETAILED_PORT_SCAN_MAX_PORTS", "1024"))
DETAILED_PORT_SCAN_TIMEOUT = float(os.getenv("DETAILED_PORT_SCAN_TIMEOUT", "0.25"))
DETAILED_PORT_SCAN_MAX_SECONDS = int(os.getenv("DETAILED_PORT_SCAN_MAX_SECONDS", "300"))
DETAILED_PORT_SCAN_MAX_QUEUED = int(os.getenv("DETAILED_PORT_SCAN_MAX_QUEUED", "20"))
